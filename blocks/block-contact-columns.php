 ...
 * Block Name: Columns
 *
 * A block that can output up to 4 columns.
 */
...
$className = 'block contact-columns';
...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> alignwide">
    <div class="contact_columns_content_column">

        <?php the_field('contact_content') ?>
        <div class="spacer"></div>
        
    </div>
	<span class="social_links_intro"><?php the_field('social_links_intro') ?></span>
        <div class="contact_columns_socials_wrapper">
            <?php
            if( have_rows('team_members', 'option') ):
                while( have_rows('team_members', 'option') ): the_row(); 

                $tImage = get_sub_field('teachers_image');
                $tName = get_sub_field('teachers_name');
                ...
                ?>
                <?php if($tFacebook || $tInstagram || $tLinkedin || $tYoutube): ?>
                    <div class="contact_columns_socials">
                        <?php 
                        ...
                        <div class="teachers_info">
                            <p class="contact_columns_teachers_name"><?php echo $tName; ?></p>

                            <div class="contact_columns_social_links">
                                <?php if($tFacebook): ?>
    ...
    <div class="contact_columns_form_column">
        <?php the_field('form_intro'); ?>
        <?php echo do_shortcode('[contact-form-7 id="229"]'); ?>
    </div>
</div>
